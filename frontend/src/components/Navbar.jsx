          ...
          >
            <div className="bg-white p-1.5 rounded-md shadow-inner transition-transform group-hover:scale-105">
              <div className="w-9 h-9 flex items-center justify-center border border-gray-200 rounded">
                {/* Minimalist National Emblem Style Icon */}
                <div className="relative w-6 h-6 flex flex-col justify-between">
                   <div className="h-2 w-full bg-[#FF9933] rounded-t-sm"></div>
                   <div className="h-2 w-full bg-white flex items-center justify-center">
                      <div className="w-1.5 h-1.5 border border-blue-800 rounded-full animate-spin-slow"></div>
                   </div>
                   <div className="h-2 w-full bg-[#138808] rounded-b-sm"></div>
                </div>
              </div>
            </div>
